...
public class XHttpFilePostTask extends XHttpTask {
    private File localFile;

    public XHttpFilePostTask(String remotePath, String localFile, int maxRetryCount, XHttpHandler handler) throws XHttpException {
