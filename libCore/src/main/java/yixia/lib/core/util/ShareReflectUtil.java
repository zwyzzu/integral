...
public class ShareReflectUtil {
    ...
    public static Method findMethod(Class<?> clazz, String name, //
        ...
        throw new NoSuchMethodException("Method " + name //
                + " with parameters " + Arrays.asList(parameterTypes) + " not found in " + clazz);
    }
     ...
     */
    public static Constructor<?> findConstructor(Object instance, //
        ...
        throw new NoSuchMethodException("Constructor" + " with parameters " //
        ...
        try {
            ...
            if (currentActivityThread == null && context != null) {
                ...
                Field mActivityThreadField //
                        = apk.getClass().getDeclaredField("mActivityThread");
