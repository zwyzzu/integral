...
import yixia.lib.core.widget.SpringInterpolator;
...
public class Tooltip extends ViewGroup {
    ...
    private Animator getAnimator(@NonNull TooltipAnimation animation,
        ...
        switch (animation.getType()) {
            case TooltipAnimation.FADE:
                return AnimationUtils.fade(this, animation.getDuration(), startAlpha, endAlpha);
            ...
            case TooltipAnimation.SCALE_AND_FADE:
                Animator scaleAnimator = getScaleAnimator(animation, size, 0.7f, 1f);
                Animator fadeAnimator = AnimationUtils.fade(this, animation.getDuration(), 0, 1);
    ...
    private void animateOut() {
        ...
        Animator animator = AnimationUtils.fade(this, 200, 1, 0);
        animator.start();
    ...
    private Animator getScaleAnimator(@NonNull TooltipAnimation animation, @NonNull int size[],
        ...
        switch (position) {
            case BOTTOM:
                return AnimationUtils.scale(contentView, size[0]/2, size[1]/2 , animation.getDuration(), scale);
            case TOP:
                return AnimationUtils.scale(contentView, size[0]/2, size[1]/2 , animation.getDuration(), scale);
            case RIGHT:
                return AnimationUtils.scale(contentView, size[0]/2, size[1]/2, animation.getDuration(), scale);
