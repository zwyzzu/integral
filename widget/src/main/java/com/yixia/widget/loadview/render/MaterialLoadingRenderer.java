package com.yixia.widget.loadview.render;
...
import yixia.lib.core.util.DensityUtils;

/**
 * https://github.com/dinuscxj/LoadingDrawable
 *
 * Created by zhujiahua on 2018/6/25.
 */
public class MaterialLoadingRenderer extends LoadingRenderer {
    ...
    private static final float DEFAULT_CENTER_RADIUS = 10.5f;
    ...
    private void init(Context context) {
        mStrokeWidth = DensityUtils.dp2px(DEFAULT_STROKE_WIDTH);
        mCenterRadius = DensityUtils.dp2px(DEFAULT_CENTER_RADIUS);
    ...
    private void apply(Builder builder) {
        ...
        this.mColors = builder.mColors != null
                &&
                builder.mColors.length > 0 ? builder.mColors : this.mColors;
