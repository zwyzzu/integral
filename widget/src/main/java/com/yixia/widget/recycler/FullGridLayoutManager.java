...
/**
 * Created by 张维亚(zhangwy) on 2016/12/19 上午10:01.
 * Updated by zhangwy on 2016/12/19 上午10:01.
 * Description 充满高度的GridLayoutManager用于RecyclerView和ScrollView嵌套
 */
@SuppressWarnings("unused")
public class FullGridLayoutManager extends GridLayoutManager {

    public FullGridLayoutManager(Context context, int spanCount) {
        super(context, spanCount);
    }

    public FullGridLayoutManager(Context context, int spanCount, int orientation, boolean
            reverseLayout) {
    ...
    public void onMeasure(RecyclerView.Recycler recycler, RecyclerView.State state, int
        ...
        for (int i = 0; i < count; i++) {
            measureScrapChild(recycler, View.MeasureSpec.makeMeasureSpec(i, View.MeasureSpec
                    .UNSPECIFIED), View.MeasureSpec.makeMeasureSpec(i, View.MeasureSpec
                    .UNSPECIFIED), mMeasuredDimension);
    ...
    private void measureScrapChild(RecyclerView.Recycler recycler, int widthSpec, int heightSpec,
